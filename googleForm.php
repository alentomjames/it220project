...
<html lang="en">
  ...
  <body>
    <form action="googleFormInserestion.php" method="POST">
      <div class="main">
        <h1>IT220 Survey</h1>
        <hr />
        <p>
          All the Submissions to this form will be anonymous.
        </p>
	  ...
	  <div class="email">
        <h3>What is your Major? <span style="color: red;">*</span></h3>
        <input type="text" name="major" id="" required />
      </div>
      <div class="submit">
